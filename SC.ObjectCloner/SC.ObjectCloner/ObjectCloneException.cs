...
{
    /// <summary>
    /// Represent an error cloning an object
    /// </summary>
    public class ObjectCloneException: Exception
    {
        ...
        protected ObjectCloneException(SerializationInfo info, StreamingContext context): base(info, context)
        {
        }
        ...
        public ObjectCloneException(string message): base(message)
        {
        }
        ...
        public ObjectCloneException(string message, Exception innerException): base(message, innerException)
        {
        }
    }
}